...
class table_access {
    ...
    public function add($array) {
        ...
        /**
     * Replace a value into the database table
     *
     * Form the array like this:
     * <code>
     * $array = array(
    ...
    public function replace($array) {
        ...
        $query = "REPLACE INTO $this->table_name (site_id";
    ...
    public function edit($array) {
        ...
        $plugins->run('query_table_access_' . $this->base_table_name . '_edit_start', $array);
        ...
        $query = "UPDATE $this->table_name tan SET tan.site_id = :site_id";

        if (isset($array['columns'])) {
            foreach($array['columns'] as $index => $value) {
                if (in_array($index, $this->allowed_columns)) {
                    $query .= ', tan.' . $index . ' = :'.$index;
                    unset($index);
                    unset($value);
                }
            }
        ...
        $query .= " WHERE tan.site_id = :site_id";
        ...
        $plugins->run('query_table_access_' . $this->base_table_name . '_edit_finish', $array);
    ...
    function delete($array) {
        ...
        $plugins->run('query_table_access_' . $this->base_table_name . '_delete_start', $array);
        ...
        //this really should be a where and not a columns array, added where below
        if (isset($array['columns'])) {
            foreach($array['columns'] as $index => $value) {
                if (in_array($index, $this->allowed_columns)) {
        ...
        $plugins->run('query_table_access_' . $this->base_table_name . '_delete_finish', $array);
            ...
            <div class="panel-heading">
                <div class="pull-left">
                    <?php if (!empty($this->custom_fields['name'])) { ?>
                        <h4><?php echo safe_output($this->custom_fields['name']); ?> - <?php echo safe_output($language->get('Custom Fields')); ?></h4>
                    <?php } else { ?>
                        <h4><?php echo safe_output($language->get('Custom Fields')); ?></h4>
                    <?php } ?>
                </div>
                <div class="pull-right">
                    <p><a href="<?php echo safe_output($config->get('address')); ?>/settings/add_cf/?table_access=<?php echo safe_output(get_called_class()); ?>" class="btn btn-primary btn-sm"><?php echo $language->get('Add'); ?></a></p>
                </div>
                <div class="clearfix"></div>
            </div>
