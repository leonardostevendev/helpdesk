...
class storage {
	...
	public function add_file_to_ticket_note($array) {
		global $db;
		...
		$add_array =  array(
			'ticket_note_id' 	=> $array['ticket_note_id'], 
			'file_id' 			=> $array['file_id']
		);
		
		if (isset($array['private'])) {
			$add_array['private']	= (int) $array['private'];
		}
		if (isset($array['ticket_id'])) {
			$add_array['ticket_id']	= (int) $array['ticket_id'];
		}
		
		$ticket_note_files->add(
			array(
				'columns' => $add_array
			)
		);
