...
class lang {
	...
	function __construct() {
		//Leave these											//Change these to your language
		...
		//5.2+
		$language_array['Create Ticket As Guest']								= 'Create Ticket As Guest';
		$language_array['Add Ticket']											= 'Add Ticket';
		$language_array['Show Open Tickets']									= 'Show Open Tickets';
		$language_array['Show Closed Tickets']									= 'Show Closed Tickets';
		$language_array['Show Extra Options']									= 'Show Extra Options';
		
		/*
			CG Changes
		*/

		$language_array['Project Manager']										= 'Project Advisor';
		$language_array['Manager']												= 'Advisor';
		$language_array['Article']												= 'Knowledge Base';
		$language_array['Articles']												= 'Knowledge Base';
		$language_array['New Article']											= 'New Knowledge Base';
		$language_array['Due']													= 'Completion';
		$language_array['Due Date']												= 'Completion Date';
		$language_array['Date Due']												= 'Completion Date';
