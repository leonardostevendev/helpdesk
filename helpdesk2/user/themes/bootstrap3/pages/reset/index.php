...
<div class="row">
	<form method="post" action="<?php echo safe_output($_SERVER['REQUEST_URI']); ?>">
		...
		<div class="col-md-9">
			...
			<div class="well well-sm">
				<div class="col-lg-6">								
					<p><?php echo safe_output($language->get('New Password')); ?><br /><input class="form-control" type="password" name="password" value="<?php if (isset($_POST['username'])) echo safe_output($_POST['username']); ?>" /></p>
					<p><?php echo safe_output($language->get('New Password Again')); ?><br /><input class="form-control" type="password" name="password2" value="<?php if (isset($_POST['username'])) echo safe_output($_POST['username']); ?>" /></p>
				</div>
				<div class="clearfix"></div>
			...
			<?php } else { ?>				
				<div class="alert alert-danger">
					<a href="#" class="close" data-dismiss="alert">&times;</a>
					<?php echo $language->get('Sorry a reset request was not found or it has expired.'); ?>
				</div>
			<?php } ?>
		</div>
	</form>
